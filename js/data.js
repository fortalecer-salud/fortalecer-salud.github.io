var solicServicio = [
    ...
    {   id:2,
        title:'2. Selección del profesional',
        text:'Nosotros procederemos a seleccionar al acompañante terapéutico o cuidador indicado para las necesidades del paciente. Contamos con un equipo de cuidadores con amplia experiencia en asistencia de cuidados de la salud.',
        srcImage:'./images/profesionales.png',
        position:'',
        bgColor:'#fff'
    },
    {   id:3,
        title:'3. Recibe al personal en tu domicilio',
        text:'Previa coordinación, el personal Acompañante Terapéutico/Enfermería se presentará en el domicilio indicado, donde realizará su trabajo según las necesidades del paciente, y usted podrá continuar con normalidad su vida cotidiana.',
